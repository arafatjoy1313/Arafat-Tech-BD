...
<head>
	...
	<title>Our Love Story</title>	<meta http-equiv="content-type" content="text/html; charset=UTF-8">
...
<body>
	...
	<script type="text/javascript">
		...
		var offsetX = $("#ArafatAhmed").width() / 2;

		var offsetY = $("#ArafatAhmed").height() / 2 - 55;
